...
SurveyMonkeyAPI_v2.prototype.execute = function (method, availableParams, givenParams, callback) {
  ...
  request({
    uri : this.httpUri+'/'+this.version+'/surveys/'+ method + "?api_key=" + this.apiKey,
    method: 'POST',
...
SurveyMonkeyAPI_v2.prototype.getRespondentList = function (params, callback) {
  ...
  this.execute('get_respondent_list', [
      'survey_id'
    ], params, callback);
};
...
SurveyMonkeyAPI_v2.prototype.getSurveyDetails = function (params, callback) {
  if (typeof params === 'function') callback = params, params = {};
  this.execute('get_survey_details', [
      'survey_id'
    ], params, callback);
};
...
SurveyMonkeyAPI_v2.prototype.getCollectorList = function (params, callback) {
  if (typeof params === 'function') callback = params, params = {};
  this.execute('get_collector_list', [
      'survey_id'
    ], params, callback);
};
...
SurveyMonkeyAPI_v2.prototype.getResponseCounts = function (params, callback) {
  if (typeof params === 'function') callback = params, params = {};
  this.execute('get_response_counts', [
      'collector_id'
    ], params, callback);
};